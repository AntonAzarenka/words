...
/**
 * Represents delete user window class.
 * <p>
 ...
 */
@Component
public class DeleteUserWindow extends CommonWidget implements IFxmlWindow {

    @Value("classpath:fxml/user/delete-user-window.fxml")
     ...
     */
    public DeleteUserWindow(ApplicationContext applicationContext) {
