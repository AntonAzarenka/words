...
@Component
public class StatisticWindow extends CommonWindowsWidget {

    @Value(value = "classpath:fxml/statistic-window.fxml")
    ...
    public StatisticWindow(ApplicationContext applicationContext) {
